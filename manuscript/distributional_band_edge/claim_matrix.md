...
| C21 | The combined framework is externally validated for a real specimen. | External material validation | No qualifying dataset yet | **Open / submission blocker** | “External validation remains pending.” | Any specimen-specific inference from the synthetic cases. |
...
| C23 | The physical Dingrong free-carrier background breaks the unified gap/carrier degeneracy. | External/model validation | Dingrong 1985, DOI `10.1016/0038-1098(85)90315-1` | **Open** | The generic marker demonstrates only the measurement principle. | Presenting the diagnostic `E^-2` marker as source physics. |
...
Claims C01–C20 support an analytical and reproducible methods paper. Claim C21 is still required before the manuscript can make a specimen-level validation claim. C22 and C23 are strengthening paths, not prerequisites for preserving the exact theorem results.