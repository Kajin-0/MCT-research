...
def composition_from_zero_intercept_300k_500um(zero_intercept_cm1: float) -> float:
    """Return source Eq. (13), restricted to its 300 K, 0.5 mm calibration."""

    zi = _finite(zero_intercept_cm1, name="zero_intercept_cm1")
    if zi <= 0.0:
        raise ValueError("zero_intercept_cm1 must be positive")
