...
| R04 | Scale-dependent spatial disorder under finite measurement kernels | Measurement-kernel-aware spatial disorder | Active-result / candidate work | Manuscript not yet authorized; experimental specification, validation-path, and prior-art gates remain | #196, #215, #218, #220, #224, #228, #230, #232, #234; PRs #199, #202, #204, #207, #210, #212, #216, #219, #221, #227, #229, #231, #233, #236 |
