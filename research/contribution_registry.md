...
| R05 | Matched correlated-random-mass versus scalar-mixture DOS benchmark | Correlated random-mass Kane | Method benchmark complete; HgCdTe physics claim not activated | No manuscript authorized | #390; PRs #391, #392, #393; final decision `REFRAME_AS_METHOD_BENCHMARK` |
