...
| R04 | Scale-dependent spatial disorder under finite measurement kernels | Measurement-kernel-aware spatial disorder | Active-result / candidate work | Manuscript not yet authorized; prior-art, validation-path, and joint-nuisance gates remain | #196, #215, #218, #220, #224, #228; PRs #199, #202, #204, #207, #210, #212, #216, #219, #221, #227, #229 |
