...
| R04 | Scale-dependent spatial disorder under finite measurement kernels | Measurement-kernel-aware spatial disorder | Active-result / candidate work; current audited external sources do not qualify for direct multiresolution validation | Manuscript not authorized; status `external_data_blocked` pending a real instrument/data package and completion of the bounded prior-art gate | #196, #215, #218, #220, #224, #228, #230, #232, #234, #246, #250; PRs #199, #202, #204, #207, #210, #212, #216, #219, #221, #227, #229, #231, #233, #236, #247, #252 |
