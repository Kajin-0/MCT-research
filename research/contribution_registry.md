...
| R04 | Scale-dependent spatial disorder under finite measurement kernels | Measurement-kernel-aware spatial disorder | Active-result / candidate work | Manuscript not yet authorized; significance, prior-art, and validation-path gates remain | #196, #215, #218, #220, #224; PRs #199, #202, #204, #207, #210, #212, #216, #219, #221, #227 |
