...
The revised spectrum figure was generated by the branch's deterministic manuscript-asset builder in GitHub Actions and then published without manual editing. The committed frozen asset is:
...
`SHA256SUMS` was updated atomically with the generated asset. The frozen figure remains a visualization of the committed reconstruction and operator results; it is not a replacement dataset or an independently measured spectrum.
