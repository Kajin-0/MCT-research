...
For unstrained bulk Hg\(_{1-x}\)Cd\(_x\)Te after configurational and thermal averaging, the effective Hamiltonian at \(\Gamma\) retains the macroscopic zincblende double-group symmetry. The \(\Gamma_6\) and \(\Gamma_8\) states belong to inequivalent irreducible representations.
