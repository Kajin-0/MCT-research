...
For bulk zincblende $\mathrm{Hg}_{1-x}\mathrm{Cd}_x\mathrm{Te}$, define the signed zone-center gap
...
- E. G. Novik et al., *Band structure of semimagnetic $\mathrm{Hg}_{1-y}\mathrm{Mn}_y\mathrm{Te}$ quantum wells*, standard 8-band Kane conventions: https://arxiv.org/abs/cond-mat/0409392
