...
def test_gaussian_smoothing_reference_values_match_ndimage_convention() -> None:
    ...
    expected = np.array(
        [
            [2.158078922023, 3.113622023011, 5.098672908131, 6.891142629397],
            [3.008157844046, 3.963700945034, 5.948751830154, 7.741221551420],
            [3.858236766069, 4.813779867057, 6.798830752177, 8.591300473443],
        ]
    )
