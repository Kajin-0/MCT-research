...
- **Citation:** E. G. Novik et al., “Band structure of semimagnetic Hg\(_{1-y}\)Mn\(_y\)Te quantum wells,” arXiv:cond-mat/0409392.
...
- **Type:** `C`
- **What it supports:** dielectric-dependent hybrid-functional calculations with spin–orbit coupling and an SQS representation for Hg\(_{0.75}\)Cd\(_{0.25}\)Te; static bandgap trends across composition are discussed.
